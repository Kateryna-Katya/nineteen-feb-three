    ...
    <section class="pages">
        <div class="container">
            ...
            <p class="lead-text" data-aos="fade-up" data-aos-delay="100">
                Мы всегда открыты для новых проектов и профессиональных дискуссий в сфере IT-образования. 
            ...
            <div class="contact-cards">
                <div class="contact-card" data-aos="zoom-in" data-aos-delay="200">
                    ...
                    <h2>Пишите нам</h2>
                    <p>Для общих вопросов, предложений и техподдержки платформы:</p>
                ...
                <div class="contact-card" data-aos="zoom-in" data-aos-delay="300">
                    ...
                    <a href="tel:+442074272890" class="contact-link">+44 20 7427 2890</a>
                </div>
                ...
                <div class="contact-card" data-aos="zoom-in" data-aos-delay="400">
                    ...
                    <h2>Наш офис</h2>
                    <p>Главный кампус компании <strong><?= $domainTitle ?></strong> расположен по адресу:</p>
                    <address class="contact-address">
                        22 Chancery Ln, Holborn,<br>
                        London WC2A 1LS,<br>
                        United Kingdom
                    </address>
                </div>
            ...
            <div class="contact-extra" data-aos="fade-up" data-aos-delay="500">
                <p>
                    Предложение активно только в странах Великобритании и ЕС. Вы также можете воспользоваться формой обратной связи на 
                    <a href="./#contact" class="inline-link">главной странице</a> для быстрой отправки запроса.
                </p>
            </div>
        </div>
    </section>
