            ...
            <div class="legal-content">
                <div class="legal-block" data-aos="fade-up">
                    ...
                    <p>
                        ...
                        обработке его данных, включая защиту прав на неприкосновенность частной жизни в рамках юрисдикции Великобритании и ЕС.
                    </p>
                    <p>
                        1.2. Политика применяется ко всей информации, которую Оператор может получить о посетителях веб-сайта <strong><?= $fullDomain ?></strong>.
                    </p>
                </div>
                ...
                <div class="legal-block" data-aos="fade-up">
                    ...
                    <ul class="terminology-list">
                        <li>
                            ...
                            <span><strong>Веб-сайт</strong> — совокупность графических и информационных материалов <?= $fullDomain ?>.</span>
                        </li>
                        <li>
                            <i data-lucide="user"></i>
                            <span><strong>Пользователь</strong> — любой посетитель веб-сайта.</span>
                        </li>
                        <li>
                            <i data-lucide="fingerprint"></i>
                            <span><strong>Персональные данные</strong> — любая информация, относящаяся к Пользователю.</span>
                        </li>
                    </ul>
                </div>
                ...
                <div class="legal-block" data-aos="fade-up">
                    ...
                    <ul class="legal-list">
                        ...
                        <li>Улучшение качества работы цифровой инфраструктуры.</li>
                    </ul>
                </div>

                <div class="legal-block contact-footer-policy" data-aos="fade-up">
                    <h2>5. Вопросы и отзывы</h2>
                    <p>Если у вас возникли вопросы, вы можете направить письмо на наш адрес электронной почты:</p>
